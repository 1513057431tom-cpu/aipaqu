...
| [ADR-004](ADR-004-mvp-closed-loop.md) | Superseded | 原报告型 MVP，已由 ADR-008 取代 |
...
| [ADR-008](ADR-008-internal-external-material-intelligence.md) | Accepted | 以内外部数据联合驱动物料与供应情报 |
